...
PKGS="7zip blueman cage calibre chafa chromium cowsay cups ddcutil fonts-noto fonts-noto-cjk easytag libexpat1-dev faketime fastfetch ffmpeg libffmpegthumbnailer4 file-roller foliate fortune-mod freerdp2-x11 fuzzel gammastep gimp gimp-plugin-registry gnome-themes-extra golang fonts-noto-color-emoji gparted grim grimpicker libgstreamer1.0-dev gstreamer1.0-plugins-bad libgstreamer-plugins-base1.0-dev gutenprint-filters libgutenprint-dev gvfs gvfs-backends HandBrake hplip htop imagemagick libimlib2-dev libexif-dev libjxl-utils libreoffice libxft-dev light lxappearance lxpolkit liblz4-dev gnome-disk-utility meson mkvtoolnix mkvtoolnix-gui moreutils mpv nasm ncdu network-manager-gnome network-manager libnm-dev ninja-build nmap opus-tools pamixer pandoc pavucontrol perl libfile-mimeinfo-perl playerctl potrace python3-setuptools python3-tk qbittorrent qt5-qmake qtbase5-dev qt5ct qt6ct sqlitebrowser steam stow strawberry sway swaylock fonts-terminus thunar thunar-archive-plugin thunar-volman tlp torbrowser-launcher tree-sitter ufw vlc waybar libwayland-dev wayland-protocols wdisplays xdg-user-dirs xsane zathura zathura-cb zathura-pdf-poppler"
