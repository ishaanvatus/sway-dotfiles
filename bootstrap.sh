...
PKGS="7z adw-gtk3-theme adwaita-icon-theme blueman cage calibre chromium cups ddcutil default-fonts-cjk easytag expat-devel faketime fastfetch ffmpeg-devel ffmpegthumbnailer file-roller flatpak foliate freerdp fuse fuse-libs fuzzel gammastep gimp gimp-resynthesizer golang google-noto-color-emoji-fonts google-noto-emoji-fonts gparted grim grimpicker gstreamer1-devel gstreamer1-plugins-bad-free-extras gstreamer1-plugins-base-devel gtk-doc gtk3-devel gutenprint gutenprint-devel gvfs gvfs-mtp gvfs-smb HandBrake HandBrake-gui hplip htop hugin hw-probe ImageMagick imlib2-devel inkscape iwlwifi-mvm-firmware kanshi keepassxc kernel-devel kdenlive krita libavif-devel libexif-devel libheif-devel libjpeg-devel libjxl-devel libjxl-utils libreoffice librsvg2-devel libtiff-devel libunrar libwebp-devel libXcursor-devel libXft-devel libXi-devel libXinerama-devel libxkbcommon-devel libXrandr-devel light lshw lz4-devel mate-polkit mediawriter meson mkvtoolnix mkvtoolnix-gui moreutils mpv mpv-mpris nasm ncdu network-manager-applet NetworkManager-tui NetworkManager-wifi ninja-build nmap opus-tools pamixer pandoc parallel pavucontrol perl-core perl-File-MimeInfo playerctl plymouth-theme-spinfinity potrace protontricks python3-setuptools python3-tkinter qbittorrent qpwgraph qt5-qtbase-devel qt5ct qt6ct rpi-imager slurp sox sqlitebrowser steam stow strawberry sway swaylock terminus-fonts-console thunar thunar-archive-plugin thunar-volman thunderbird tlp torbrowser-launcher tree-sitter-cli unrar vlc waybar waydroid wayland-devel wayland-protocols-devel wdisplays weechat wl-clipboard xdg-user-dirs xsane zathura zathura-cb zathura-pdf-mupdf"
